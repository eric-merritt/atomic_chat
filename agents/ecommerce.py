"""Ecommerce agent — MCP server for eBay, Amazon, Craigslist searches.
...
SYSTEM_PROMPT = """Search ecommerce platforms and return structured listing data.
...
if __name__ == "__main__":
    app = create_app()
    app.run(transport="streamable-http", port=AGENT_PORTS["ecommerce"])
