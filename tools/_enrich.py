...
def enrich_data(data: str, goal: str, max_iterations: int = 5, eval_model: str = 'qwen3:4b') -> dict:
    ...
    try:
        ...
        return tool_result(error=f"Failed to initialize eval model '{eval_model}': {e}. Ensure llama.cpp server is running and the model is loaded.")
...
_ENRICH_PARAMS = {
    ...
    'enrich_model':      {'type': 'string',  'description': 'Model for enrichment. Default: qwen3:4b.'},
}
