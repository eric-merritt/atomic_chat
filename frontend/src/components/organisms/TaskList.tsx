...
const TEST_TASKS = [
  `Set the following cookies for '.gayporntube.com':[
    {
        "name": "kt_member",
        "value": "75d9f0dfcf0b133299b3f160354b9a1d",
    },
    {
        "name": "kt_remote_ips",
    ...
    {
        "name": "PHPSESSID",
        "value": "rodma6rh963d88nsosfeii5im5",
    }
]`,
  "Navigate to 'https://gayporntube.com/search/videos/friends-jerk-together/'. You MUST include the trailing slash or you will hit a 404.",
  "Display the results using ap_gallery. Call get_params(ap_gallery) if you're confused on formatting."
]
